...
$javabin/javac -target 1.6 -classpath . org/smogserver/wham/*.java org/smogserver/io/*.java org/smogserver/util/*.java org/smogserver/util/geom/*.java org/smogserver/util/math/*.java org/smogserver/util/exception/DoneException.java ral/*java
